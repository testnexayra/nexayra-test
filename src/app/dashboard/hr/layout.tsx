...
export default function HRLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div>
      <h1 className="font-display text-3xl font-bold text-navy dark:text-white mb-4 animate-fade-in-up">Human Resources</h1>
      <div className="flex gap-1 mb-6 overflow-x-auto border-b border-navy-100 dark:border-navy-700 animate-fade-in-up delay-1">
        {TABS.map(tab => {
