...
export default function SubTabLayout({ title, tabs, children }: { title: string; tabs: Tab[]; children: React.ReactNode }) {
  const pathname = usePathname();

  return (
    <div>
      <h1 className="font-display text-3xl font-bold text-navy mb-4 animate-fade-in-up">{title}</h1>
